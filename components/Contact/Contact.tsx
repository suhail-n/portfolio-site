    ...
    return (
        <section id="contact" className="flex justify-center bg-bgPrimary-light dark:bg-bgPrimary-dark">
            <div className="flex flex-col justify-center min-h-screen max-h-screen p-10 sm:p-0 gap-5">
                ...
                <h3 className="sm:text-xl text-lg text-gray-500 dark:text-gray-400 my-2 max-w-sm lg:max-w-xl sm:max-w-lg">I'm currently living the dream as a Senior Engineer and I'm not searching for any new opportunities. However, I'm always open for a coffee chat. Feel free to send me a message</h3>
